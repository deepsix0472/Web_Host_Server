        ...
        <div className={styles.authBranding}>
          <div className={styles.authBrandingContent}>
            ...
            <div className={styles.authTestimonial}>
              ...
              <div className={styles.authTestimonialAuthor}>
                <div className={styles.authTestimonialAvatar}>SC</div>
                <div>
                  <div className={styles.authTestimonialName}>Sarah Chen</div>
                  <div className={styles.authTestimonialRole}>Head Coach, Aquatic Stars</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={styles.authFormContainer}>
            ...
            <form className={styles.authForm} onSubmit={handleSubmit}>
              ...
              <div className={styles.formCheckboxGroup}>
                ...
                <label htmlFor="remember" className={styles.formCheckboxLabel}>Remember me for 30 days</label>
              </div>
            ...
            <div className={styles.authSocialButtons}>
              <button className={`btn btn-secondary ${styles.authSocialBtn}`} disabled>
            ...
            <p className={styles.authFormFooter}>
              Don&apos;t have an account? <Link href="/register" className={styles.formLink}>Sign up for free</Link>
            </p>
          </div>
        </div>
      </div>
